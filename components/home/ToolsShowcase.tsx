...
const tools = [
  { icon: <Code2 className="w-5 h-5" />,        label: "Code Lab ✨",               description: "Solve 45+ AI/ML coding problems, earn XP levels",  href: "/code-lab",                  color: "text-orange-400", bg: "bg-orange-500/10 border-orange-500/20" },
