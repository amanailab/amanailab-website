...
const tools = [
  { icon: <Code2 className="w-5 h-5" />,        label: "Code Lab ✨",               description: `Solve ${SITE_STATS.codeProblems}+ AI/ML coding problems, earn XP levels`,  href: "/code-lab",                  color: "text-orange-400", bg: "bg-orange-500/10 border-orange-500/20" },
  ...
  { icon: <Library className="w-5 h-5" />,     label: "Question Bank",            description: `Browse & filter ${SITE_STATS.questions} AI/ML interview questions`,       href: "/questions",          color: "text-purple-400", bg: "bg-purple-500/10 border-purple-500/20"},
  ...
  { icon: <ScrollText className="w-5 h-5" />,  label: "Paper Explainer",          description: "Any arXiv paper explained in plain English",           href: "/paper-explainer",    color: "text-indigo-400", bg: "bg-indigo-500/10 border-indigo-500/20"},
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-orange-500/10 border border-orange-500/20 text-orange-400 text-xs font-semibold px-3.5 py-1.5 rounded-full mb-4 uppercase tracking-wider">
            ...
            {SITE_STATS.tools} Free AI Tools
          </div>
