      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-24">
        ...
        {loading && (
          <div className="flex flex-col items-center justify-center py-20 gap-4">
            ...
            <p className="text-zinc-500 text-sm">Reading and analyzing the paper…</p>
          </div>
        )}
        ...
        {result && (
          <div className="flex flex-col gap-5">
            ...
            <div className="bg-gradient-to-br from-violet-500/10 to-violet-500/5 border border-violet-500/20 rounded-2xl p-6">
              ...
              {/* One-liner */}
              <p className="text-sm font-medium text-zinc-200 italic">"{result.oneLiner}"</p>

              {/* Importance */}
              <p className="text-xs text-zinc-500 mt-2">{result.importanceReason}</p>
            </div>
