...
const CAREER: Package[] = [
  {
    ...
    price: "₹1,999",
    usd: "~$24",
    tagline: "The perfect launchpad for your AI journey",
    badge: null,
    ...
    groups: [
      {
        ...
        items: [
          "30-minute strategy call with Aman to define direction & scope",
          ...
          "Step-by-step build guide (works even without prior experience)",
        ],
      },
      {
        ...
        items: [
          ...
          "5 impactful resume bullet points written specifically for this project",
          "LinkedIn post template to announce your new project",
        ],
      },
      {
        heading: "💬 Support",
        items: [
          "5-day priority WhatsApp support for questions during the build",
          "1 follow-up review after you complete the project",
        ],
      },
    ],
  },
    ...
    groups: [
      {
        ...
        items: [
          ...
          "Detailed inline code explanation doc — Aman annotates every component",
          "Custom project idea + full architecture document + build guide",
          "GitHub starter code template with clean folder structure",
        ],
      },
      {
        heading: "🎤 Interview Preparation",
        items: [
          "30 project-specific Q&As with model answers (from easy to tough)",
          "2 live mock interview sessions (45 min each) with AI scoring & feedback",
          "Post-session written feedback report with exact areas to improve",
        ],
      },
      {
        heading: "📄 Career Materials",
        items: [
          "LinkedIn post template + announcement strategy for maximum reach",
          "GitHub README template (looks professional to recruiters)",
          "5 tailored resume bullet points (ATS-optimized)",
          "Full resume review with line-by-line specific suggestions",
        ],
      },
      {
        heading: "💬 Support",
        items: [
          "14-day priority WhatsApp support",
          "1 free revision after delivery if anything needs tweaking",
        ],
      },
    ],
  },
    ...
    groups: [
      {
        ...
        items: [
          ...
          "Detailed inline code explanation docs for both projects — every component annotated",
          "Custom ideas + architecture + build guides for both",
          "GitHub starter templates with clean, recruiter-ready structure",
          "Personalized 30-day placement roadmap built around your timeline",
        ],
      },
      {
        heading: "🎤 Interview Preparation",
        items: [
          "50+ project-specific Q&As with model answers (25 per project)",
          "5 live mock interview sessions with detailed written feedback reports",
          "Company-specific interview simulation — we mimic their actual process",
          "Behavioural interview prep + STAR-format answer templates",
        ],
      },
      {
        ...
        items: [
          ...
          "Full LinkedIn profile overhaul (headline, about, experience, featured, skills)",
          "LinkedIn post + GitHub README templates for both projects",
          "Job application strategy + personalized company shortlist (10+ companies)",
        ],
      },
      {
        heading: "🤝 Personal Mentorship",
        items: [
          "6 weekly 1-on-1 check-in calls with Aman",
          "Weekly progress report — track every milestone until your offer",
    ...
    groups: [
      {
        ...
        items: [
          "Single-page custom website — no templates, every pixel hand-coded",
          "Modern dark design with Framer Motion animations",
          "Mobile-first, fast-loading (Lighthouse 90+ score guaranteed)",
          "30-minute design consultation call before build starts",
        ],
      },
      {
        heading: "🤖 AI Features",
        items: [
          "2–3 AI-powered tools (choose from: chatbot, content analyzer, resume reviewer, or generator)",
          "Real AI integration via Groq or OpenAI API",
          "Custom prompt engineering tailored to your audience",
        ],
      },
      {
        heading: "🚀 Launch",
        items: [
          "Deployed live on Vercel with CI/CD pipeline",
      ...
      },
      {
        heading: "💬 Support",
        items: [
          "14-day post-launch WhatsApp support",
...
const CAREER_STEPS = [
  ...
  { n: "03", icon: Code2,         title: "We build together",      desc: "Working code, annotated explanations, mock interviews — step by step." },
...
const CAREER_COMPARE: CompareTable = {
  ...
  rows: [
    ...
    { label: "Code explanation doc",        vals: ["—", "✓", "✓ (both)"] },
    { label: "Live mock interviews",        vals: ["—", "2 sessions", "5 sessions"] },
    { label: "Project Q&As with answers",   vals: ["—", "30", "50+"] },
    { label: "Resume help",                 vals: ["5 bullets", "Full review", "Full rewrite"] },
    { label: "LinkedIn profile overhaul",   vals: ["—", "—", "✓"] },
    { label: "1-on-1 mentor calls",         vals: ["—", "—", "6 weekly"] },
    { label: "Support",                     vals: ["5 days", "14 days", "Until placed"] },
  ],
}
