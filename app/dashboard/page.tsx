...
const TOOLKIT = [
  ...
  },
  {
    ...
    icon: Building2,
    label: 'Company Prep',
    desc: 'Google, Meta, OpenAI & 6 more',
    color: 'text-blue-400',
  ...
  },
  {
    ...
    icon: Library,
    label: 'Question Bank',
    desc: 'Browse & study 500+ questions',
  ...
  },
  {
    ...
    icon: Briefcase,
    label: 'Job Prep',
    desc: 'Paste a JD → get tailored questions',
    color: 'text-teal-400',
  ...
  },
  {
    ...
    icon: MessageSquare,
    label: 'Community',
    desc: 'Real interview experiences shared',
  ...
  },
  {
    ...
    desc: 'Week-by-week AI/ML learning path',
    color: 'text-pink-400',
  ...
  },
  {
    ...
    desc: 'ATS score & AI improvements',
  ...
  },
  {
    ...
    desc: 'Understand any research paper',
    color: 'text-cyan-400',
...
export default async function DashboardPage() {
  ...
  // Smart "What to do next" items (max 3, personalized)
  ...
  nextActions.push({
    ...
    sub: 'Google, Meta, OpenAI, Anthropic & more — company-specific questions',
    href: '/companies',
  ...
  nextActions.push({
    ...
    sub: 'Get 6 tailored questions for any role in seconds',
    href: '/job-prep',
    ...
    <div className="min-h-screen bg-zinc-950 pt-20 pb-16">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="flex flex-col gap-5">
          ...
          {/* ── What To Do Next (personalized, always shown) ── */}
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5">
          ...
          {/* ── Preparation Toolkit (always shown) ── */}
          <PreparationToolkit />
