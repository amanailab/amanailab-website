...
const TOOLKIT = [
  ...
  { href: '/career?tab=job-questions', icon: Briefcase, label: 'JD → Questions', desc: 'Paste JD → tailored questions', color: 'text-teal-400',   bg: 'bg-teal-500/10 border-teal-500/20'   },
