...
import {
  ...
  Copy, Check, Download, Share2, Zap,
} from 'lucide-react'
...
export default function JobPrepPage() {
  ...
  function buildExportText(r: Result): string {
    const lines: string[] = [
      ...
      '',
      'Generated by AmanAI Lab — amanailab.com/job-prep',
    ]
    return lines.join('\n')
  }
      ...
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-zinc-400 text-sm max-w-xl mx-auto leading-relaxed">
            Paste any AI/ML job description. Get required skills, 6 tailored questions with model answers, and a personalised study plan — in 10 seconds.
          </p>
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5">
              <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-xs font-semibold text-zinc-500 uppercase tracking-wide">Share This Tool</p>
              </div>
              <p className="text-xs text-zinc-600">
                Know someone preparing for a {result.role} role? Share AmanAI Lab — it's free.
              </p>
              <CopyBtn text={`Preparing for ${result.role} interviews? Use AmanAI Lab to get tailored questions from any JD: https://amanailab.com/job-prep`} label="Copy Link" />
            </div>
