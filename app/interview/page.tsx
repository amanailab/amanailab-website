...
export const metadata: Metadata = {
  ...
  description: 'Practice AI/ML interview questions with an AI interviewer. Voice-enabled, instant scoring (0-10), model answers. 14 topics including LLM, RAG, Agents, MLOps, System Design, Computer Vision, NLP and more. Free.',
  ...
  openGraph: {
    ...
    images: [{ url: '/api/og/tool?name=AI+Mock+Interview&tagline=Voice-enabled+scoring+on+14+topics&emoji=%F0%9F%A7%A0&tool=interview', width: 1200, height: 630 }],
  },
  twitter: {
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'What AI/ML topics does the simulator cover?', acceptedAnswer: { '@type': 'Answer', text: '14 topics: LLM, RAG, Agents, Fine-Tuning, MLOps, Transformers, System Design, Python, Vector DB, Computer Vision, NLP, Statistics, and Behavioral.' } },
