...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      '231+ curated topics: Transformers, RAG, LoRA, LangGraph, MCP, MLOps and more. Complete this sheet and land your dream AI/ML job.',
    images: [
      {
        url: '/api/og/tool?name=AI+A2Z+Sheet&tagline=231%2B+topics+%E2%80%94+Interview+Ready&emoji=%E2%9C%A8&tool=sheet',
        width: 1200,
        height: 630,
      },
    ],
...
const faqJsonLd = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: 'What is the AI Interview Prep Sheet?', acceptedAnswer: { '@type': 'Answer', text: 'A structured roadmap of 231 topics across 7 tracks (Generative AI, Agentic AI, Deep Learning, ML, MLOps, System Design, 2026 Frontier) with inline theory, linked code problems, flashcards, quizzes, and a system design practice workspace. Inspired by Striver\'s A2Z DSA Sheet but built for 2026 AI/ML interviews.' } },
