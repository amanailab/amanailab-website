...
const TRACKS_RAW: SheetTrack[] = [
  ...
  // ─── TRACK 0: INTERVIEW STRATEGY & BEHAVIORAL ───────────────────────────────
  {
    id: 'strategy',
    title: 'Interview Strategy',
    description: 'How AI/ML interviews actually work — rounds, resume, behavioral STAR stories, game-day tactics & negotiation',
    ...
    sections: [
      {
        id: 'strategy-process',
        title: 'How AI/ML Interviews Work',
        estimatedTime: '~1h',
        items: [
          item('sp-1', 'The AI/ML Interview Loop — Rounds & What Each Tests', 'theory', 'easy', {
            companies: ['Google', 'Meta', 'Amazon', 'OpenAI'],
            theory: 'A typical AI/ML loop has 4-6 rounds: (1) Recruiter screen — motivation, salary range, logistics. (2) Technical phone screen — 1 coding question + ML fundamentals. (3) ML depth — deep dive into your strongest area and past projects. (4) ML breadth — rapid-fire fundamentals across the field. (5) ML system design — design a real system end-to-end. (6) Behavioral — past-experience stories. Each round has a separate interviewer filing an independent score; one strong "no" usually sinks the loop, so you cannot afford a weak round. This sheet\'s phases map to these rounds: Foundations + tracks → depth/breadth, System Design track → design round, this track → behavioral.',
          }),
          item('sp-2', 'Recruiter Screen — Pass the First Filter', 'theory', 'easy', {
            theory: 'The recruiter screen filters for: a coherent 90-second self-pitch, genuine interest in the company, and matching logistics (visa, location, level, salary band). Prepare a tight pitch (see "Tell Me About Yourself" below), 2-3 specific reasons you want THIS company (a product you use, a paper they published, their open-source work), and deflect salary questions politely: "I\'m flexible and more focused on fit — what\'s the band for this level?" Never give a number first if you can avoid it.',
          }),
          item('sp-3', 'ML Depth vs ML Breadth Rounds — Different Games', 'theory', 'medium', {
            companies: ['Meta', 'Google', 'Amazon'],
            theory: 'Depth rounds drill into ONE area — usually your own resume: "You used LoRA, derive why low-rank updates work. What rank did you pick and why?" The interviewer keeps asking "why" until you break; getting 3-4 levels deep is a strong signal. Breadth rounds sweep many topics fast: bias-variance, attention complexity, when RAG beats fine-tuning — 60-90 seconds per answer. Strategy: for depth, own everything on your resume to "could re-implement it" level. For breadth, practice concise first-pass answers (this sheet\'s Quiz checkpoints train exactly that), then expand only if asked.',
          }),
          item('sp-4', 'How Interviewers Grade You — Signals & Rubrics', 'theory', 'medium', {
            companies: ['Google', 'Amazon', 'Meta'],
            theory: 'Interviewers file written feedback against rubrics, typically: problem solving (did you structure the problem before solving?), technical depth (correct AND nuanced — trade-offs, failure modes), communication (could they follow your thinking?), and seniority signals (did you ask clarifying questions, push back when appropriate, quantify impact?). Practical implication: a slightly wrong answer delivered with clear structured reasoning often scores HIGHER than a right answer mumbled without explanation. Always narrate your thinking — it\'s the main thing being graded.',
          }),
          item('sp-5', 'Make a Target List & Application Strategy', 'project', 'easy', {
            theory: 'Apply in waves, not all at once. Wave 1 (week 1-2): 3-5 "practice" companies you\'d accept but aren\'t your dream — real interviews are the best mock interviews. Wave 2 (week 3-4): your target companies, once you\'ve warmed up. Referrals roughly 5-10× your callback rate vs cold applications — message 2nd-degree connections doing the role you want, ask for 15 minutes of advice (not a referral), and let the referral emerge. Track every application in the Job Tracker so follow-ups never slip.',
          }),
        ],
      },
      {
        id: 'strategy-resume',
        title: 'Resume & Projects That Get Callbacks',
        estimatedTime: '~1.5h',
        items: [
          item('srm-1', 'AI/ML Resume — Structure, Keywords & Quantified Impact', 'theory', 'easy', {
            theory: 'One page. Sections: header (GitHub + LinkedIn links), skills (grouped: Languages / ML / Infra), experience, projects, education. Every bullet = action verb + what you built + quantified outcome: "Fine-tuned Llama-3-8B with QLoRA on 40K support tickets, cutting first-response time 35%". Recruiters spend ~7 seconds; ATS systems match keywords from the JD — mirror the JD\'s exact terms (if they say "RAG", write "RAG", not just "retrieval"). Run your resume through the Resume Analyzer on this site for an ATS score and missing-keyword list before sending it anywhere.',
          }),
          item('srm-2', 'Choose 2-3 Portfolio Projects That Stand Out', 'project', 'medium', {
            theory: 'Three strong projects beat ten tutorials. A standout AI/ML project has: (1) a real problem with real/messy data — not MNIST or Titanic; (2) an end-to-end pipeline — ingestion, training/RAG, evaluation, deployed demo; (3) evaluation numbers — "RAGAS faithfulness 0.91, p95 latency 800ms"; (4) a README with an architecture diagram and trade-off discussion. Strong 2026 picks: a RAG system over a niche corpus with measured retrieval quality, a fine-tuned small model beating a prompted large model on a specific task (with cost comparison), or an agent that does a real multi-step job with tool use and guardrails.',
          }),
          item('srm-3', 'Telling the Project Story — Architecture, Trade-offs, Metrics', 'theory', 'medium', {
            companies: ['Meta', 'Google', 'Amazon'],
            theory: 'Interviewers probe projects with "why" questions, so prepare each project as a 5-part story: (1) Problem & why it matters — one sentence. (2) Architecture — draw it from memory. (3) The hardest technical decision and the alternatives you rejected ("I chose pgvector over Pinecone because the corpus was <1M vectors and we already ran Postgres — managed vector DBs added cost and a network hop"). (4) Results with numbers. (5) What you\'d do differently now. The trade-off discussion is where senior signal lives — practice saying what you considered and rejected, not just what you did.',
          }),
          item('srm-4', 'GitHub & LinkedIn Hygiene Before You Apply', 'project', 'easy', {
            theory: 'Recruiters WILL click your links. GitHub: pin your 3 best repos, each with a README (what it does, architecture diagram, how to run, demo GIF), and make sure recent commit history isn\'t empty — a green graph signals an active builder. LinkedIn: headline = role + specialty ("ML Engineer · LLMs & RAG"), About section = your pitch in writing, and turn on "Open to Work" (recruiters-only mode). Use the LinkedIn Optimizer on this site to rewrite your headline and About with the right keywords.',
          }),
        ],
      },
      {
        id: 'strategy-behavioral',
        title: 'Behavioral & STAR Stories',
        estimatedTime: '~2.5h',
        items: [
          item('sb-1', 'The STAR Method — Structure Every Answer', 'theory', 'easy', {
            quizTopic: 'Behavioral', hasQuiz: true,
            companies: ['Amazon', 'Google', 'Meta', 'Microsoft'],
            theory: 'STAR = Situation, Task, Action, Result. Situation (2 sentences): context — team, product, constraint. Task (1 sentence): YOUR specific responsibility. Action (the core, ~60%): what YOU did, step by step — say "I", not "we". Result (2 sentences): quantified outcome + what you learned. Target 2-3 minutes per answer. The most common failures: rambling situations, "we did X" hiding your contribution, and missing numbers in the result. Prepare 6-8 stories covering: a hard technical problem, a conflict, a failure, leadership/initiative, ambiguity, and a tight deadline — most behavioral questions are one of these in disguise.',
            preview: { q: 'Why do interviewers insist on specific past examples instead of hypotheticals?', a: 'Past behavior predicts future behavior far better than self-described intentions. "What would you do if…" invites idealized answers anyone can invent; "Tell me about a time you actually…" forces evidence. Interviewers also probe follow-ups ("what did the other person say next?") that are easy to answer truthfully from a real memory but very hard to fake consistently — that\'s the built-in lie detector.' },
          }),
          item('sb-2', '"Tell Me About Yourself" — The 90-Second Pitch', 'interview', 'easy', {
            quizTopic: 'Behavioral', hasInterview: true,
            theory: 'Structure: present → past → future, 90 seconds max. Present: who you are and your specialty ("I\'m an ML engineer focused on LLM applications — RAG and fine-tuning"). Past: 2 proof points with numbers ("I built X, which achieved Y"). Future: why this role specifically ("I want to work on production-scale LLM systems, which is exactly what this team ships"). Practice it out loud until smooth but not robotic. This answer sets the tone of every interview and feeds the interviewer their follow-up questions — seed it with the projects you WANT to be asked about.',
          }),
          item('sb-3', '"Tell Me About a Challenging Project" — Model Answer', 'interview', 'medium', {
            quizTopic: 'Behavioral', hasInterview: true,
            companies: ['Google', 'Meta', 'Amazon'],
            theory: 'Pick a project with genuine technical difficulty, not just long hours. Strong shape: "Our RAG system\'s answers degraded as the corpus grew (S). I owned retrieval quality (T). I built an eval set of 200 question-document pairs, measured recall@5 at 61%, diagnosed that chunking was splitting tables mid-row, switched to structure-aware chunking plus a reranker, and A/B tested (A). Recall hit 89% and support-ticket deflection rose 12% (R)." Note the pattern: measured first, diagnosed root cause, fixed, verified with numbers. That diagnostic loop is the senior signal interviewers want.',
          }),
          item('sb-4', 'Conflict & Disagreement Questions', 'interview', 'medium', {
            quizTopic: 'Behavioral', hasInterview: true,
            companies: ['Amazon', 'Meta', 'Apple'],
            theory: '"Tell me about a time you disagreed with a teammate/manager." The trap: badmouthing the other side or claiming you\'ve never had conflict (reads as dishonest or junior). Winning shape: a real technical disagreement, steelman the OTHER side first ("they wanted a managed service for good reasons — less ops burden"), then how you resolved it with DATA, not authority ("I benchmarked both options on our workload and shared the numbers"), and a resolution where the relationship stayed healthy. Bonus points if you were the one proven wrong and changed your mind — owning that is a strong maturity signal.',
          }),
          item('sb-5', 'Failure & Mistake Questions — Owning It', 'interview', 'medium', {
            quizTopic: 'Behavioral', hasInterview: true,
            companies: ['Amazon', 'Google', 'Netflix'],
            theory: 'Pick a REAL failure with real consequences — "my failure is I work too hard" is an instant red flag. Structure: what happened, the impact (own it plainly: "my migration script corrupted 3 hours of user events"), the immediate fix, and — most important — the systemic change you made so it can\'t recur ("I added a dry-run mode and made staged rollouts the team default"). Interviewers are testing for blame-shifting vs ownership, and whether you convert failures into systems. Never pick a failure caused by someone else; that\'s blame-shifting wearing a costume.',
          }),
          item('sb-6', '"Why This Company?" — Research-Backed Answers', 'interview', 'easy', {
            quizTopic: 'Behavioral',
            theory: 'Generic answers ("great culture, cutting-edge AI") are filler — interviewers hear them daily. Do 30 minutes of research and name SPECIFIC things: a product feature you use, a blog post or paper their team published, their open-source repos, a public engineering decision you found interesting. Then connect to your goals: "Your team published how you serve LLMs at scale with speculative decoding — inference optimization is exactly the area I want to go deep in." Specificity is the entire game; one researched sentence beats five enthusiastic ones.',
          }),
          item('sb-7', 'Leadership & Initiative Stories (Amazon LP Style)', 'interview', 'medium', {
            quizTopic: 'Behavioral', hasInterview: true,
            companies: ['Amazon', 'Microsoft'],
            theory: 'Leadership questions ("took ownership beyond your role", "influenced without authority") don\'t require a manager title — they want initiative. Strong sources: you noticed a problem nobody owned and fixed it; you wrote the doc/eval/tooling that changed the team\'s direction; you mentored someone to independence. Amazon specifically grades against its Leadership Principles (Ownership, Dive Deep, Bias for Action, Deliver Results) — re-read them before any Amazon loop and tag each of your stories to 2-3 LPs. The same stories work everywhere; Amazon just scores them against named principles.',
          }),
          item('sb-8', 'Questions YOU Ask the Interviewer', 'theory', 'easy', {
            theory: '"Any questions for me?" is still part of the interview. Skip questions answerable by Google (funding, product basics). Strong picks: "What does the first 90 days look like for this role?", "What\'s the hardest technical problem the team is facing right now?", "How does the team evaluate ML work — what does \'good\' look like at review time?", "What separates a good hire from a great one here?" Ask 2-3, listen actively, follow up on their answer. For the hiring manager round, add: "What would make you say in 6 months that hiring me was a great decision?"',
          }),
        ],
      },
      {
        id: 'strategy-gameday',
        title: 'Game Day & Negotiation',
        estimatedTime: '~1h',
        items: [
          item('sg-1', 'Day-Before & Day-Of Checklist', 'theory', 'easy', {
            theory: 'Day before: re-read the JD and your resume (you WILL be asked about both), review your 6-8 STAR stories, skim — don\'t cram — your weakest topics, prepare your questions for the interviewer, test camera/mic/IDE, sleep. Day of: water, notebook for keywords during questions, join 3 minutes early. Between back-to-back rounds, take the 5-minute break — stand up, reset; carrying frustration from a bad round into the next one is the most common self-inflicted wound. Each interviewer scores independently: a bad round does NOT decide the loop unless you let it bleed forward.',
          }),
          item('sg-2', 'Thinking Aloud — Communicate While Solving', 'theory', 'medium', {
            companies: ['Google', 'Meta', 'OpenAI'],
            theory: 'Silent solving reads as failing even when you\'re right. Protocol: (1) Restate the problem in your own words and confirm. (2) Ask 1-2 clarifying questions (scale? constraints? edge cases?). (3) State your approach BEFORE diving in: "I\'ll start with brute force, then optimize the bottleneck." (4) Narrate decisions as you go — especially when rejecting an option. (5) When stuck, say what you\'re stuck on out loud: "The issue is making this O(n) — let me think about what I could precompute." That sentence converts dead silence into a collaboration signal, and frequently earns a hint without penalty.',
          }),
          item('sg-3', 'When You Don\'t Know the Answer — Recovery Tactics', 'theory', 'medium', {
            theory: 'Never bluff — interviewers are experts and a confident wrong answer is far worse than honest reasoning. Recovery ladder: (1) Decompose: "I haven\'t used DPO directly, but I know it removes PPO\'s reward model — let me reason from there." (2) Bridge from what you know: connect to an adjacent concept you DO know well. (3) Say how you\'d find out: "I\'d benchmark both on our eval set — here\'s what I\'d measure." (4) Plain honesty for total blanks: "I don\'t know — could you give me a pointer? I\'d like to try reasoning through it." One unknown answered with structured reasoning routinely scores better than three memorized answers.',
          }),
          item('sg-4', 'Offer Negotiation Basics for AI/ML Roles', 'theory', 'medium', {
            theory: 'Almost every offer has 10-20% headroom, and negotiating is expected — done politely, it has near-zero risk of losing the offer. Rules: (1) Never accept on the call; "I\'m excited — let me review and get back to you in 2 days." (2) Competing offers are the strongest lever; even a pending loop elsewhere helps ("I\'m in final rounds with X"). (3) Negotiate total comp, not just base — equity and sign-on bonus usually move more than salary. (4) Make ONE well-reasoned counter, not a haggle: "Given my LLM production experience and the market for this role, I was hoping for X total." Paste your offer into the Offer Analyzer (Career tools) for a market read and a negotiation script.',
          }),
        ],
      },
      {
        id: 'strategy-checkpoint',
        title: '🏁 Checkpoint — Prove It',
        estimatedTime: '~1.5h',
        items: [
          item('scp-1', 'Checkpoint: Write your 6-8 STAR stories & rehearse out loud', 'interview', 'medium', {
            theory: 'Don\'t check this until the stories exist in writing. Cover: hard technical problem, conflict, failure, leadership/initiative, ambiguity, tight deadline. For each: 3-4 bullet STAR outline with real numbers in the Result. Then rehearse each once OUT LOUD — written stories that have never been spoken fall apart under interview pressure. Total: 6-8 stories, each tellable in 2-3 minutes.',
          }),
          item('scp-2', 'Checkpoint: Behavioral mock interview — score 7+/10', 'interview', 'medium', {
            quizTopic: 'Behavioral', hasInterview: true,
            theory: 'Run a Behavioral session in the AI Simulator and score 7+/10 average. The AI grades structure (STAR), specificity, and ownership language — the same things human interviewers grade. If you score below 7, the feedback will tell you which story was vague; tighten it and retake. Pass bar: 7+/10.',
          }),
          item('scp-3', 'Checkpoint: Resume scores 75+ on the Resume Analyzer', 'project', 'easy', {
            theory: 'Upload your resume to the Resume Analyzer (Tools → Resume Analyzer) with a real target JD pasted in. Pass bar: ATS score 75+, no missing must-have keywords for your target role, and every experience bullet quantified. Fix what it flags and re-run before checking this off — this is the resume you\'ll actually send.',
          }),
        ],
      },
    ],
...
export const SHEET_PHASES: SheetPhase[] = [
  { num: 1, title: 'Foundations',  subtitle: 'The ground everything builds on',   trackIds: ['strategy', 'ml', 'deeplearning'] },
